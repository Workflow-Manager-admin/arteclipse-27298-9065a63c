...
function UserProfile() {
  ...
  // Minimalist address state for profile page (local only)
  const [address, setAddress] = React.useState("");

  return (
    <div style={{ width: "100%", paddingTop: 35 }}>
      <div className="subtitle">Profile</div>
      <h1 className="title" style={{ fontWeight: 200, fontSize: "2.40rem", marginBottom: 2 }}>
      ...
      <div style={profileGridStyle}>
        ...
        <section style={cardStyle} aria-label="Personal Information">
          ...
          {/* Minimalist Address Box – harmonized with other pages */}
          <div
