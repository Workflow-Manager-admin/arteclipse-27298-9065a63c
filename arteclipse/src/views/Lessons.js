  ...
  return (
    <div className="lesson-card-thumbnail" aria-label="Video thumbnail placeholder">
      <svg width="72" height="46" viewBox="0 0 72 46" fill="none" style={{ display: "block" }}>
        ...
        <polygon points="30,16 48,23 30,30" fill="rgba(46,196,253,0.26)"/>
      </svg>
    </div>
  );
}
...
function Lessons() {
  ...
  // Minimalist address box state (mirrors Home.js logic)
  ...
  return (
    ...
    >
      {/* Minimalist Address Box - style matches Home.js */}
      <div
        aria-label="Address Input or Display"
        style={{
          width: "100%",
          maxWidth: 370,
          margin: "24px 0 18px 52px", // Left padding matches .lessons-intro
      ...
      >
        ...
        {address && (
          ...
          >
            <span style={{ color: "var(--kavia-blue, #2ec4fd)", marginRight: 6 }}>Address:</span>
            {address}
          </div>
        )}
      </div>
